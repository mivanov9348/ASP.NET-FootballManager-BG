    ...
    public partial class AddDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContinentalCups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContinentalCupId = table.Column<int>(type: "int", nullable: true),
                    GameId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Draws_ContinentalCups_ContinentalCupId",
                        column: x => x.ContinentalCupId,
                        principalTable: "ContinentalCups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Draws_Cups_CupId",
                        column: x => x.CupId,
                        principalTable: "Cups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Teams_ContinentalCups_EuropeanCupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VirtualTeams_ContinentalCups_EuropeanCupId",
                        column: x => x.EuropeanCupId,
                        principalTable: "ContinentalCups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fixtures_ContinentalCups_EuropeanCupId",
                        column: x => x.EuropeanCupId,
                        principalTable: "ContinentalCups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContinentalCups_GameId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Draws_ContinentalCupId",
                table: "Draws",
                column: "ContinentalCupId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ContinentalCups_Games_GameId",
                table: "ContinentalCups",
                column: "GameId",
                principalTable: "Games",
                principalColumn: "Id",
